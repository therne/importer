/*
 * Importer - Helps you to import all modules in a given directory.
...
/**
 * Retrieves all modules in a given directory and calls handler.
 *
...
function importerSync(options, handler) {
    ...
    if (modulePath.indexOf('/') != 0) {
        ...
        modulePath = path.join(path.dirname(module.parent.filename), modulePath);
    }
